...
Output: 20190301
Explanation:
The first event occurs at timestamp = 20190101 and after 0 and 1 become friends we have the following friendship groups
 [0,1], [2], [3], [4], [5].
The second event occurs at timestamp = 20190104 and after 3 and 4 become friends we have the following friendship groups
 [0,1], [2], [3,4], [5].
The third event occurs at timestamp = 20190107 and after 2 and 3 become friends we have the following friendship groups
 [0,1], [2,3,4], [5].
The fourth event occurs at timestamp = 20190211 and after 1 and 5 become friends we have the following friendship groups
 [0,1,5], [2,3,4].
...
# All the values timestampi are unique.
# All the pairs (xi, yi) occur at most one time in the input.
# Very similar to leetcode 547
# Obviously, we need to process logs in the timestamp order.
class UnionFind:
    def __init__(self, size):
        self.root = [-1 for i in range(size)]
        self.rank = [1] * size
        self.groups = size
