...
class HitCounter:
    ...
    def getHits(self, timestamp: int) -> int:   # O(N)
        #  hint: timestamp is monotonically increasing. Returns the number of hits in the past 5 minutes from timestamp
        #  if >=300, delete it
...
###### Binary Search ---------------> hint: timestamp is monotonically increasing
